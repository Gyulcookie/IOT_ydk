...
<%
	...
	String qry = "update board1 set hits=hits+1 where unq = '"+unq+"'";
	
	stmt.executeUpdate(qry);
	
	String sql = "select title, name, content, to_char(rdate,'yyyy/mm/dd') as rdate from board1 where unq = '"+unq+"'";
